 ...
 */
final class DockSizeData extends PreviewSizeData<Float> {
    public static final float FONT_SCALE_DEF_VALUE = 1.0f;
    public static final String DOCK_SCALE = "dock_scale";

    DockSizeData(Context context) {
        super(context);
        final Resources resources = getContext().getResources();
        final ContentResolver resolver = getContext().getContentResolver();
        final List<String> strEntryValues =
                Arrays.asList(resources.getStringArray(R.array.entryvalues_dock_size));
        setDefaultValue(getDockScaleDefValue(resolver));        
        final float currentScale =
                Settings.System.getFloat(resolver, DOCK_SCALE, FONT_SCALE_DEF_VALUE);
    ...
    void commit(int currentProgress) {
        final ContentResolver resolver = getContext().getContentResolver();
        Settings.System.putFloat(resolver, DOCK_SCALE,
    ...
    private float getDockScaleDefValue(ContentResolver resolver) {
